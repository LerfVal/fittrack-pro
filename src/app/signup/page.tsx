    ...
    >
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-zinc-900 flex-col justify-between p-12">
        ...
        <div className="relative flex items-center gap-3">
          ...
          <span className="text-white font-bold text-xl tracking-tight">FitTrack</span>
        </div>
        ...
        <div className="relative">
          ...
          <div className="flex flex-col gap-5">
            {[
              { icon: "📈", title: "Progress charts", desc: "Visualize strength gains over time" },
              { icon: "🏆", title: "Personal records", desc: "Automatically tracked on every lift" },
              { icon: "📋", title: "Custom workouts", desc: "Build programs that fit your goals" },
            ].map((f) => (
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-md">
          ...
          <p className="text-zinc-400 mb-8">Start tracking your training today.</p>
